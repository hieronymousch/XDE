...
<!-- Generate HTML5 WebPage -->
	...
	<html>
		...
		<body>
			...
			<xsl:if test="count(//dbquery[@id='IL_MR_DOSS']/rows/row)=0">
				<center>
					<h2>This Report Requires the MRQR Dossier Extraction in your Local DB Node.</h2>
				</center>
			</xsl:if>
