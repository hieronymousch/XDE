	...
	<html>
		...
		<body>
			...
			<xsl:call-template name="Generic_Table_DBWEB">
				...
				<xsl:with-param name="UdTN" select="'IL_MR_PREQ_DETAILS_PUR_REQ-pPREQ'"/>
				<xsl:with-param name="ForcedTitle" select="'PREQ Additional information'"/>	
				<xsl:with-param name="ForceFooter" select="'N'"/> 
				
			</xsl:call-template>
			<xsl:call-template name="Generic_Table_DBWEB">
				<xsl:with-param name="DBWEB_Name" select="'IL_MR_PREQ_DETAILS_PUR_REQ_VER'"/>
				<xsl:with-param name="UdTN" select="'IL_MR_PREQ_DETAILS_PUR_REQ_VER-pPREQ'"/>
			...
			<xsl:call-template name="Generic_Table_DBWEB">
				...
				<xsl:with-param name="UdTN" select="'IL_MR_DOSS-pPREQ'"/>
				<xsl:with-param name="ForcedTitle" select="'Dossier'"/>			
			</xsl:call-template>
						
			<xsl:call-template name="Generic_Table_DBWEB">
				<xsl:with-param name="DBWEB_Name" select="'IMPUTATION'"/>
				<xsl:with-param name="UdTN" select="'IMPUTATION-pPREQ'"/>
