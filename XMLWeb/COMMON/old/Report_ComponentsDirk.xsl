...
<!-- Active Templates used for FW3 -->
	...
	<xsl:template name="SPE_Feature">				<!-- Template For Special Features -->
					...
					<xsl:when test="$SPE_Type='00'"> <!-- Treat as Html Syntax -->
						...
						<xsl:if test="not($SPE_Val) or $SPE_Val!=''">
							...
							<script>
								...
								write("<xsl:value-of select='$SPE_Val'/>");
							</script>
						</xsl:if>
					</xsl:when>
	...
	<xsl:template name="ReportSecurity"> 			<!-- Template For Security -->
		...
		<xsl:choose>
			<xsl:when test="$tSecType='None'">
		    	...
		    	<xsl:call-template name="TNotif">
					...
					<xsl:with-param name="tTitle" select="'T31 - Security Not Activated'"/> 
		    ...
		    <xsl:when test="$tSecType='User' and $tSecOutput='html'">
		    	<xsl:call-template name="TNotif">
					<xsl:with-param name="tMsg" select="'Report Security has been activated on this Report and you are not granted to access this Report. Please contact Report Developper or Node Administrator'"/>
					<xsl:with-param name="tTitle" select="'T29 - Security Activated : Access Denied'"/> 
		    ...
		    <xsl:otherwise>
		    	<xsl:call-template name="TNotif">
					...
					<xsl:with-param name="tTitle" select="'T30 - Security Activated : Unknown Type Code'"/> 
					<xsl:with-param name="tType" select="3"/> 	
					<xsl:with-param name="tAppear" select="1000"/>
					<xsl:with-param name="tDuration" select="3000"/>  	
				</xsl:call-template>
					...
					<xsl:for-each-group select = "//dbquery[@id=$DBWEB]/rows/row[(@*[local-name() = $vR1])=$v1Row]" group-by="@*[local-name() = $vR2]">
						...
						<tr>
							<xsl:if test="$vCodeR1='NONE'">
								<td>
									<xsl:attribute name="data-order"><xsl:value-of select="$v1Row"/></xsl:attribute>
									<xsl:attribute name="class">MRNC11</xsl:attribute>
							...
							<xsl:if test="$vR1!=$vR2 and $vR2!='NONE'">
								<xsl:if test="$vCodeR2='NONE'">
									<td>
										<xsl:attribute name="data-order"><xsl:value-of select="$v2Row"/></xsl:attribute>
						...
						<xsl:when test="$tDDConfig='CIP' or $tDDConfig='CP' or $tDDConfig='IP'">
							...
							<xsl:if test="//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@POPUP=-1">
								...
								<script>
									...
									new Opentip("#"+unIdDD, "&lt;b>&lt;u>&lt;i>Explanation&lt;/i>&lt;/u>&lt;/b>&lt;br/><xsl:value-of select="if(//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT='' or not(//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT)) then 'No Explanation Provided' else (//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT)" />&lt;br/><xsl:if test="count(//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S])>1">&lt;br/>&lt;b>Warning : Multiple DataDic Entry in RepDic (Correction Required)&lt;/b>&lt;br/></xsl:if>&lt;br/>&lt;i>&lt;small>Source (DD3A) : DBWeb Node with Lang Param '<xsl:value-of select='$Lang'/>'.&lt;br/>Original Field Name : '<xsl:value-of select='$Title2S'/>'.&lt;/i>&lt;/small>", {background: "#d3fedf", target: false, tipJoint: "bottom left"});
								</script>
							</xsl:if>
						</xsl:when>
						<!-- Trapping -->
						...
						<xsl:when test="$tDDConfig='CIP' or $tDDConfig='CP' or $tDDConfig='IP'">
							...
							<xsl:if test="//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@POPUP=-1">
								...
								<script>
									var unIdDD= uniqueid();
									$('#DDToBeChanged').attr('id',unIdDD);
									new Opentip("#"+unIdDD, "&lt;b>&lt;u>&lt;i>Explanation&lt;/i>&lt;/u>&lt;/b>&lt;br/><xsl:value-of select="if(//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT='' or not(//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT)) then 'No Explanation Provided' else (//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT)" />&lt;br/><xsl:if test="count(//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S])>1">&lt;br/>&lt;b>Warning : Multiple DataDic Entry in RepDic (Correction Required)&lt;/b>&lt;br/></xsl:if>&lt;br/>&lt;i>&lt;small>&lt;u>Original Field Name&lt;/u> : '<xsl:value-of select='$Title2S'/>'.&lt;/i>&lt;br/>&lt;u>ILIAS Hint&lt;/u> : Nbr <xsl:value-of select="//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@HINT_NO"/> in Screen <xsl:value-of select="//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@FUNCTION"/>.&lt;br/>&lt;u>View Used&lt;/u> : <xsl:value-of select="//dbquery[@id='DATA_DICTIONARY']/rows/row[@NAME=$Title2S]/@VIEWNAME"/> in ILIAS (See in MITONE Screen).&lt;br/>&lt;u>Source (DD4A)&lt;/u> : DBWeb Node with Lang Param '<xsl:value-of select='$Lang'/>'.&lt;/small>", {background: "#e6f8ff", target: false, tipJoint: "bottom left"});
								</script>
							</xsl:if>
						</xsl:when>
						<!-- Trapping -->
				...
				<xsl:choose>
					...
					<xsl:when test="$tDDConfig='CIP' or $tDDConfig='CP' or $tDDConfig='IP'">
						...
						<script>
							var unIdDD= uniqueid();
							$('#DDToBeChanged').attr('id',unIdDD);
							new Opentip("#"+unIdDD, "&lt;b>&lt;u>&lt;i>Explanation&lt;/i>&lt;/u>&lt;/b>&lt;br/><xsl:value-of select="if($dictionary//Label[@ID=$Title2S]/PopupText[upper-case(@lang)=$Lang]='' or not($dictionary//Label[@ID=$Title2S]/PopupText[upper-case(@lang)=$Lang])) then 'No Explanation Provided' else ($dictionary//Label[@ID=$Title2S]/PopupText[upper-case(@lang)=$Lang])" />&lt;br/><xsl:if test="count($dictionary//Label[@ID=$Title2S]/LabelText[upper-case(@lang)=$Lang])>1">&lt;br/>&lt;b>Warning : Multiple DataDic Entry in RepDic (Correction Required)&lt;/b>&lt;br/></xsl:if>&lt;br/>&lt;i>&lt;small>Source (DD2A) : Local XML (...RepDic.xml) with Lang Param '<xsl:value-of select='$Lang'/>'.&lt;br/>Original Field Name : '<xsl:value-of select='$Title2S'/>'.&lt;/i>&lt;/small>", {background: "#f8fbb6", target: false, tipJoint: "bottom left"});
						</script>
					</xsl:when>
					<!-- Trapping -->
					<xsl:otherwise>
				...
				<xsl:choose>
					...
					<xsl:when test="$tDDConfig='CIP' or $tDDConfig='CP' or $tDDConfig='IP'">
						...
						<script>
							var unIdDD= uniqueid();
							$('#DDToBeChanged').attr('id',unIdDD);
							new Opentip("#"+unIdDD, "&lt;b>&lt;u>&lt;i>Field Not Defined in Data Dictionary (DBWeb) and in RepDic (.xml)&lt;/i>&lt;/u>&lt;/b>&lt;br/>No Label and Pop-Up defined in Report Dictionary. Help Us to define it.&lt;br/>&lt;br/>&lt;i>&lt;small>Source (DD1A) : No DBWeb DD And No RepDic with Lang Param '<xsl:value-of select='$Lang'/>'.&lt;br/>Original Field Name : '<xsl:value-of select='$Title2S'/>'.&lt;/i>&lt;/small>", {background: "#fcadc1", target: false, tipJoint: "bottom left"});
						</script>
					</xsl:when>
					<!-- Trapping -->
					<xsl:otherwise>
...
<!-- For KPI -->
	...
	<xsl:template name="Generic_Tab"> 							<!-- v2 - Template For Generic Tab -->
	...
	<xsl:template name="Gen_Tab_Header"> 						<!-- v2 - Template For Generic Tab Header -->
	...
	<xsl:template name="Gen_Tab_Content"> 						<!-- v2 - Template For Generic Tab Content -->
		<xsl:param name="tTAB_UnId" select="'KPIDETREP'"/> 			<!-- Unique String for Id generation -->
		<xsl:param name="tDD_UnId" select="'DD_KPIDETREP'"/> 			<!-- Unique String for Id generation -->
		<xsl:param name="tStart" select="1" />
	    <xsl:param name="tLoop" select="1" />
